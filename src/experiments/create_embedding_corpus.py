...
#             "format": "events_with_ids",  # Use new format that returns both events and token_ids
...
#             # Get the label and token_ids
#             label = item['label']
#             token_ids = item['token_ids']
            
#             # Save the embeddings, token_ids, and label to a file
#             output_data = {
